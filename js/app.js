...
class UI {
   ...
   imprimirCitas({citas}) { // Se puede aplicar destructuring desde la función...
        ...
        citas.forEach(cita => {
            ...
            telefonoParrafo.innerHTML = `<span class="font-weight-bolder">Tel: </span> ${telefono}`;
            ...
            sintomasParrafo.innerHTML = `<span class="font-weight-bolder">symptom: </span> ${sintomas}`;
...
function nuevaCita(e) {
    ...
    if(editando) {
        ...
        ui.imprimirAlerta('Added');

        formulario.querySelector('button[type="submit"]').textContent = 'Create';
...
function cargarEdicion(cita) {
    ...
    formulario.querySelector('button[type="submit"]').textContent = 'Save';
